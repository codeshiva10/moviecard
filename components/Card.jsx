const Card = (props) => {
  return (
    <>
      <div className="  border-1 solid white w-70 h-125 bg-amber-400 shadow-lg shadow-indigo-500/50 p-3 rounded-2xl">
        <img src={props.image} alt="Moviecard" className="h-70 w-70 rounded-2xl" />
        <h1>
       ...
       <div className="flex flex-col justify-end">
          <div className="  flex justify-center items-center  bg-white  cursor-pointer  rounded-xl text-green-700 mb-2 "> 
